...
class LoanedBookInstancesByUserListViewTestCase(TestCase):
    def setUp(self):
        # Create two users
    ...
    def test_pages_ordered_by_due_date(self):
        # Change all boooks to be on loan
        ...
        # Check that the books ordered by "due_back"
        last_date = 0
    ...
    def test_pagination(self):
        ...
        response = self.client.get(reverse('catalog:my-borrowed')+'?page=2')
        self.assertEqual(response.status_code, 200)
        self.assertTrue('is_paginated' in response.context)
        self.assertTrue(response.context['is_paginated'] == True)
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_form_date_of_death_initially_is_11_06_2020(self):
        login = self.client.login(
            username='testuser2', password='2HJ1vRV0Z&3iD'
        )
        response = self.client.get(reverse('catalog:author-create'))
